...
use kaspa_consensus_core::tx::{
    CovenantBinding, Transaction, TransactionOutput, UtxoEntry,
};
...
// ===========================================================================
//
// The builders themselves now live in `src/v5.rs`: the generative oracle
// needed `delegate2` from a second binary, and a builder only one file can
// reach is a builder only one file can check.
// ===========================================================================
