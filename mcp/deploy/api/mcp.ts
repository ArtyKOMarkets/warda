 ...
 * handler, so every request died. It was not wrong to guess: a directory
 * holding both a library and a function is ambiguous. This directory holds
 * nothing but the function: no `src/`, no `main`, no build script.
 *
